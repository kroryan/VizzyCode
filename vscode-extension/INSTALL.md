...
If the release includes `vizzycode-tools-0.0.3.vsix`, install it with either:

```powershell
code --install-extension .\vizzycode-tools-0.0.3.vsix --force
```
...
4. Select `vizzycode-tools-0.0.3.vsix`
